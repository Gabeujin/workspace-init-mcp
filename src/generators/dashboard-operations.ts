...
function buildDashboardOpsScript(): string {
  ...
  return [
    ...
    '  const basePaths = [".github/ai-harness/harness-manifest.yaml", ".github/ai-harness/managed-file-inventory.json", ".github/ai-harness/reconcile-policy.json", ".github/ai-harness/native-executor-overrides.json", ".github/ai-harness/operating-model.md", "docs/context/", "docs/reviews/", "docs/plans/", "docs/handovers/", "docs/work-logs/", "docs/ai-harness/readiness/README.md", "docs/ai-harness/readiness/remaining-work-spec.md", "docs/ai-harness/readiness/scoring-model.md", "docs/ai-harness/readiness/maturity-scorecard.template.json", "docs/ai-harness/runtime/README.md", "docs/ai-harness/runtime/state/session-index.json", "docs/ai-harness/runtime/state/active-session.json", "docs/ai-harness/runtime/state/current-work-packet.json", "docs/ai-harness/runtime/state/current-execution-bridge.json", "docs/ai-harness/runtime/state/current-native-execution.json", "docs/ai-harness/runtime/work-packets/README.md", "docs/ai-harness/runtime/adapters/README.md", "docs/ai-harness/runtime/adapter-handoffs/README.md", "docs/ai-harness/runtime/bridges/README.md", "docs/ai-harness/runtime/execution-bridges/README.md", "docs/ai-harness/runtime/native-executors/README.md", "docs/ai-harness/runtime/archive/README.md", "docs/ai-harness/runtime/archive/archive-index.json", "docs/ai-harness/dashboard/state/dashboard-state.json"];',
