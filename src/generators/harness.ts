...
- Harness Dashboard 4.6.4 Hypertext Project World Model generated.
...
- \`docs/ai-harness/dashboard/\`: Harness Dashboard 4.6.4 Hypertext Project World Model, ledger projections, single-file HTML, and read-only local API design system
