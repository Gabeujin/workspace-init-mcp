  ...
  return `${JSON.stringify(
    {
      ...
      versions: [
        ...
        },
        {
          ...
          releaseTheme:
            "Semantic Governance major update with architecture ontology, source graph, enforcement, and policy packs",
          capabilities: [
            ...
            "architecture-ontology-policy",
            "typescript-javascript-source-graph",
            "semantic-governance-evaluation",
            "semantic-warehouse-query",
            "semantic-context-pack",
            "architecture-waiver-validation",
            "opt-in-architecture-enforcement",
            "architecture-policy-pack-gitops",
            "safe-contained-workspace-writes",
          ],
          introducedFiles: [
          ...
          upgradeNotes: [
            ...
            "Run scan_source_graph and validate_architecture_governance before treating architecture claims as verified.",
            "Use enforce_architecture_governance in report mode locally and strict or ci mode for release gates.",
            "Policy pack imports are review-only by default and require reviewer, trusted approval signature, approval ref, prior review receipt, exact review signature, and backup receipt before local policy changes.",
            "The local listener is restored on harness activity and remains loopback-only, token-protected, and read-only.",
            "Optional backend dashboard apps are blueprints only in 5.0.0 and are not generated by default.",
  ...
  return `${JSON.stringify(
    {
      ...
      upgradePaths: [
        ...
        },
        {
          ...
          to: RUNTIME_COMPATIBILITY_VERSION,
          requiredActions: [
            "Regenerate runtime compatibility files so 5.0.0 Semantic Governance capabilities appear in version-index.json.",
            ...
            "Install dashboard ledger, projection, entity, design framework, read-only listener, ontology, waiver, enforcement, warehouse, and policy-pack files.",
          ],
          preserve: [
        ...
        },
        {
          ...
          to: RUNTIME_COMPATIBILITY_VERSION,
          requiredActions: [
            "Replace the server-status dashboard baseline with the 5.0.0 Semantic Governance and ledger-backed Hypertext Project World Model.",
            ...
            "Install architecture ontology policy, semantic source graph state, waiver validation, enforcement report, semantic warehouse, and policy-pack GitOps artifacts.",
