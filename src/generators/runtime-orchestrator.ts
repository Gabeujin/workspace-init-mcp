      ...
      versions: [
        ...
        },
        {
          ...
          upgradeNotes: [
            ...
            "Optional backend dashboard apps are blueprints only in 4.6.6 and are not generated by default.",
  ...
  return `${JSON.stringify(
    {
      ...
      upgradePaths: [
        ...
        },
        {
          ...
          to: RUNTIME_COMPATIBILITY_VERSION,
          requiredActions: [
            "Regenerate runtime compatibility files so 4.6.6 Hypertext Project World Model governance appears in version-index.json.",
        ...
        },
        {
          ...
          to: RUNTIME_COMPATIBILITY_VERSION,
          requiredActions: [
            "Replace the server-status dashboard baseline with the 4.6.6 ledger-backed Hypertext Project World Model.",
