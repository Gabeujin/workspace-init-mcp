...
/**
 * workspace-init-mcp MCP Server v4.6.4
 *
...
- docs/ai-harness/dashboard/ (Harness Dashboard 4.6.4 Hypertext Project World Model with ledger, projections, single-file HTML, and read-only local API)
...
server.registerTool(
  "get_harness_dashboard_context",
  {
    ...
    description: `Read the Harness Dashboard 4.6.4 Hypertext Project World Model projections for AI Agent resume context.
