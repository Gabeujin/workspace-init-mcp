...
export const AGENT_REGISTRY: AgentEntry[] = [
  ...
  },
  {
    ...
    description: "Maintains and matures the Harness Dashboard 4.6.8 Hypertext Project World Model, ledger projections, governance/evidence scores, briefs, VCS evidence, and read-only local listener",
  ...
  },
  {
    ...
    categories: ["meta", "documentation", "review"],
    tags: ["legacy", "reconcile", "migration", "backup", "restore", "dry-run", "safety"],
    relevantProjectTypes: ["*"],
    techKeywords: ["Git", "JSON", "MCP"],
    priority: 1,
  },
  {
    id: "cli-runtime-bridge-operator",
    name: "CLI Runtime Bridge Operator",
    description: "Coordinates governed handoffs and portable launch guidance for CLI-based agent runtimes across local and sandboxed environments",
    categories: ["platform", "meta", "devops"],
    tags: ["cli", "runtime-bridge", "codex", "claude", "gemini", "sandbox", "portable"],
    relevantProjectTypes: ["*"],
    techKeywords: ["CLI", "MCP", "JSON"],
    priority: 1,
  },
  {
  ...
  {
    id: "harness-memory-curator",
    name: "Harness Memory Curator",
    description: "Detects repeated session-memory patterns and turns stable recurring work into proposed or generated skills and agents",
    categories: ["meta", "documentation", "planning"],
    tags: ["memory", "pattern-mining", "skill-factory", "agent-factory", "harness", "continuity"],
    relevantProjectTypes: ["*"],
    techKeywords: ["AI", "LLM", "MCP"],
    priority: 1,
  },
  {
...
export const SKILL_REGISTRY: SkillEntry[] = [
  ...
  },
  {
    ...
    description: "Maintains HTML-backed Harness Dashboard 4.6.8 world-model projections, maturity contracts, briefs, dictionary, VCS records, and listener state without using a database",
  ...
  },
  {
    ...
    categories: ["migration", "governance", "analysis"],
    tags: ["reconcile", "migration", "legacy", "backup", "restore", "dry-run", "managed-files"],
    relevantProjectTypes: ["*"],
    techKeywords: ["Git", "JSON", "MCP"],
    hasResources: true,
    priority: 1,
  ...
  {
    id: "cli-runtime-bridge-orchestration",
    ...
    categories: ["mcp", "governance", "analysis"],
    tags: ["cli", "runtime-bridge", "codex", "claude", "gemini", "portable", "sandbox"],
    relevantProjectTypes: ["*"],
    techKeywords: ["CLI", "MCP", "JSON"],
    hasResources: true,
    priority: 1,
  ...
  {
    id: "harness-memory-pattern-miner",
    name: "Harness Memory Pattern Miner",
    description: "Analyzes session memories, work logs, and governance traces to identify recurring stable workflows and create bounded skill or agent candidates",
    categories: ["memory", "analysis", "governance", "project-setup"],
    tags: ["memory", "pattern-mining", "skill-factory", "agent-factory", "harness", "repeat-work", "continuity"],
    relevantProjectTypes: ["*"],
    techKeywords: ["AI", "LLM", "MCP"],
    hasResources: true,
    priority: 1,
