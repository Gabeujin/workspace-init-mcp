...
export const AGENT_REGISTRY: AgentEntry[] = [
  ...
  },
  {
    ...
    description: "Maintains and matures the Harness Dashboard 4.6.7 Hypertext Project World Model, ledger projections, governance/evidence scores, briefs, VCS evidence, and read-only local listener",
...
export const SKILL_REGISTRY: SkillEntry[] = [
  ...
  },
  {
    ...
    description: "Maintains HTML-backed Harness Dashboard 4.6.7 world-model projections, maturity contracts, briefs, dictionary, VCS records, and listener state without using a database",
